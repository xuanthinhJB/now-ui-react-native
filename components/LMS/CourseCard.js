    ...
    return (
      <Block row={horizontal} card flex style={cardContainer}>
        <TouchableWithoutFeedback
          onPress={() => navigation.navigate('LMS_Learning', { screen: 'LMS_Course_Learning' })}
        >
        ...
        >
          <Block flex space="between" style={styles.cardDescription}>
            <Block flex>
              <Text
                style={{ ...titleStyles[0], fontFamily: 'montserrat-regular' }}
                size={14}
            ...
            <Block right={ctaRight ? true : false}>
              <Text
                ...
                bold
              >
                {formatter.formatVnCurrency(item.price)}
              </Text>
            </Block>
          </Block>
        </TouchableWithoutFeedback>
